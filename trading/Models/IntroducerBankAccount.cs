...
{
    public partial class IntroducerBankAccount
    {
        ...
        [Remote("IsExist", "IntroducerBankAccount", AdditionalFields = "id", ErrorMessage = "Account exist already")]
    ...
    public partial class IntroducerBankAccountView
    {
        public int id { get; set; }
