USE [master]
GO
/****** Object:  Database [DB_A6159D_tradingPRD]    Script Date: 11/27/2020 8:17:36 PM ******/
CREATE DATABASE [DB_A6159D_tradingPRD]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'trading', FILENAME = N'H:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\DB_A6159D_tradingPRD_data.mdf' , SIZE = 10112KB , MAXSIZE = 1024000KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'trading_log', FILENAME = N'H:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\DB_A6159D_tradingPRD_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [DB_A6159D_tradingPRD].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ARITHABORT OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET  DISABLE_BROKER 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET  MULTI_USER 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET DB_CHAINING OFF 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET QUERY_STORE = OFF
GO
USE [DB_A6159D_tradingPRD]
GO
/****** Object:  Table [dbo].[ClientTradingProfile]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ClientTradingProfileIntroducerMap]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Payout]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Payout](
	...
	[ProviderPayinUSDRate] [decimal](18, 7) NOT NULL,
	[UsedCurrencyID] [tinyint] NOT NULL,
	[UsedAmount] [decimal](18, 4) NOT NULL,
	[UsedClientPayoutFXRate] [decimal](18, 7) NOT NULL,
	[UsedUSDRate] [decimal](18, 7) NOT NULL,
...
GO
/****** Object:  Table [dbo].[Currency]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AccountBankAccount]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CurrencyPair]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Txn]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Txn](
	...
	[ClientDfrRate] [decimal](20, 7) NULL,
	[ClientUniqueDfr] [bit] NOT NULL,
	[ClientExRate] [decimal](20, 8) NULL,
	...
	[ProviderCostRate] [decimal](20, 6) NULL,
	[ProviderExpectedPayInAmount] [decimal](18, 4) NULL,
	[ProviderBankAccountID] [int] NULL,
	[Remark] [nchar](1000) NULL,
	[PayoutDone] [bit] NULL,
	[PayoutDoneByID] [int] NULL,
	[MiniAccount] [bit] NULL,
	[OvernightDeposit] [bit] NULL,
	[DateTimeModified] [datetime] NOT NULL,
...
GO
/****** Object:  Table [dbo].[Account]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProviderTradingProfile]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProviderBankAccount]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[TxnView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[TxnCompleteView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT t1.id, t1.ReferenceNo, t1.Type, t1.LinkedDepositID, t1.TradeDate, t1.ClientTradingProfileID, t1.Status, t1.ClientPriceRate, t1.ClientCurrencyPairID, t1.ClientDfrRate, t1.ClientUniqueDfr, t1.ClientExRate, t1.ClientCurrencyIDIn, 
                  ...
                  ISNULL(t2.ProviderBankAccountName, t1.ProviderBankAccountName) AS LinkedProviderBankAccountName, ISNULL(t1.ClientAmountOut, 0) - ISNULL(pout.ClientPayoutAmount, 0) AS ClientPayoutAmountOutstanding
FROM     dbo.TxnView AS t1 LEFT OUTER JOIN
                  dbo.TxnView AS t2 ON t1.LinkedDepositID = t2.id LEFT OUTER JOIN
                      (SELECT TxnID, SUM(ClientPayoutAmount) AS ClientPayoutAmount
                       FROM      dbo.Payout
                       GROUP BY TxnID) AS pout ON t1.id = pout.TxnID
GO
/****** Object:  View [dbo].[PayoutView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT p.id, p.ReferenceNo, p.TxnID, t.ClientCurrencyIDOut AS ClientPayoutCurrencyID, p.ClientPayoutAmount, p.ClientPayoutUSDRate, t.LinkedProviderCurrencyID AS ProviderPayinCurrencyID, 
                  ...
                  t.ClientTradingProfileID, t.ClientTradingProfileName, t.LinkedProviderTradingProfileID, t.LinkedProviderTradingProfileName, p.AccountBankAccountID, ab.AccountName
...
GO
/****** Object:  View [dbo].[ReportTxnModified]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[ReportTxnModified]
AS
...
t.ReferenceNo, t.TradeDate, 
t.ClientCurrencyIDIn,t.ClientCurrencyNameIn,t.ClientAmountIn,
t.ClientCurrencyIDOut,t.ClientCurrencyNameOut,t.ClientAmountOut,
c.ClientID,t.ClientTradingProfileID,t.ClientTradingProfileName,t.ProviderTradingProfileID,t.ProviderTradingProfileName,
...
CASE
    WHEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) > 0 
		THEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) * (1-isnull(comm1.IntroducerCommissionRate+0.25,0.5))
    ELSE 
	    (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2)
END AS GrossProfitUSD,

CASE
    WHEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) > 0 
		THEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) * (1-isnull(comm1.IntroducerCommissionRate+0.25,0.5))*100/o.ClientPayoutUSD
    ELSE 
	    (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) *100/o.ClientPayoutUSD
END AS GrossProfitUSDPct,

--(i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) * (1-isnull(comm1.IntroducerCommissionRate+0.25,0.5)) as GrossProfitUSD,
--(i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) * (1-isnull(comm1.IntroducerCommissionRate+0.25,0.5))*100/o.ClientPayoutUSD as GrossProfitUSDPct,
'A' as Role
from pin i
...
left outer join ClientTradingProfile c on t.ClientTradingProfileID=c.id

GO
/****** Object:  View [dbo].[ReportTxnOriginal]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[ReportTxnOriginal]
AS
...
CASE
    WHEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) > 0 
		THEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) * (1-isnull(comm1.IntroducerCommissionRate,0))
    ELSE 
	    (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2)
END AS GrossProfitUSD,
...
CASE
    WHEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) > 0 
		THEN (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) * (1-isnull(comm1.IntroducerCommissionRate,0))*100/o.ClientPayoutUSD
    ELSE 
	    (i.ProviderPayinUSD - o.ClientPayoutUSD - o.IntroducerCommissionUSD2) *100/o.ClientPayoutUSD
END AS GrossProfitUSDPct,
...
GO
/****** Object:  Table [dbo].[Introducer]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[IntroducerView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FROM     dbo.Introducer
GO
/****** Object:  Table [dbo].[AccountType]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IntroducerBankAccount]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Country]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[IntroducerBankAccountView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Client]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ClientType]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ClientView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ClientTradingProfileView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ClientBankAccount]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ClientBankAccountView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IntroducerCommissionType]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ClientTradingProfileIntroducerMapView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[AccountBankAccountView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Provider]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ProviderBankAccountView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ProviderTradingProfileView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProviderTradingProfileIntroducerMap]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ProviderTradingProfileIntroducerMapView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FROM     dbo.ProviderTradingProfileIntroducerMap AS map LEFT OUTER JOIN
                  ...
                  dbo.IntroducerCommissionType AS ict ON map.IntroducerCommissionTypeID = ict.id
GO
/****** Object:  View [dbo].[CurrencyPairView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sender]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Slip]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[SlipView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT s.id, s.ReferenceNo, s.SlipDate, s.ProviderTradingProfileID, s.TxnID, s.AccountBankAccountID, s.SenderID, s.SlipAmount, s.ActualAmount, s.DateTimeModified, s.DateTimeAdded, p.ProviderTradingProfileName, 
                  t.ReferenceNo AS TxnReferenceNo, a.AccountName AS AccountBankAccountName, sdr.SenderName, cp.CurrencyName2
FROM     dbo.Slip AS s LEFT OUTER JOIN
                  dbo.ProviderTradingProfile AS p ON s.ProviderTradingProfileID = p.id LEFT OUTER JOIN
                  dbo.CurrencyPairView AS cp ON p.CurrencyPairID = cp.id LEFT OUTER JOIN
...
GO
/****** Object:  View [dbo].[ReportProvider]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ReportAccount]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AccountAdjust]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[AccountAdjustView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT ad.id, ad.ReferenceNo, ad.AccountBankAccountID, ad.Amount, ad.ActualDate, ad.Reference, ad.DateTimeModified, ad.DateTimeAdded, ab.AccountName
FROM     dbo.AccountAdjust AS ad LEFT OUTER JOIN
                  dbo.AccountBankAccount AS ab ON ad.AccountBankAccountID = ab.id
GO
/****** Object:  Table [dbo].[AccountTransfer]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[AccountTransferView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT at.id, at.ReferenceNo, at.AccountBankAccountIDFrom, at.AccountBankAccountIDTo, at.Amount, at.Rate, at.ActualDate, at.Reference, at.DateTimeModified, at.DateTimeAdded, abf.AccountName AS AccountBankAccountNameFrom, 
...
GO
/****** Object:  View [dbo].[ReportTxn]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT *
FROM     ReportTxnModified
UNION
SELECT *
FROM     ReportTxnOriginal 
GO
/****** Object:  Table [dbo].[AccountTxn]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[AccountTxnView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Dfr]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ReportAccountBalance]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[DfrLatestView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
select CurrencyPairID, 
	...
	where rn = 1   
GO
/****** Object:  View [dbo].[ReportAccountPayable]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ReportAccountReceivable]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
WITH s(ProviderTradingProfileID, TotalSlipAmount) AS (SELECT ProviderTradingProfileID, SUM(ISNULL(SlipAmount, 0)) AS TotalSlipAmount
                                                                                                             ...
                                                                                                             GROUP BY ProviderTradingProfileID)
    SELECT ProviderID, ProviderTradingProfileID, ProviderTradingProfileName, AmountReceivable, CurrencyName2, AmountReceivableUSD, Rate
    FROM     (SELECT ptp.ProviderID, r.ProviderTradingProfileID, r.ProviderTradingProfileName, ISNULL(r.MissingSlipAmount, 0) + ISNULL(s_1.TotalSlipAmount, 0) AS AmountReceivable, cp1.CurrencyName2, (ISNULL(r.MissingSlipAmount, 0) 
                                        + ISNULL(s_1.TotalSlipAmount, 0)) * d.Rate AS AmountReceivableUSD, d.Rate
                      FROM      dbo.ReportProvider AS r LEFT OUTER JOIN
                                        ...
                                        dbo.DfrLatestView AS d ON cp2.id = d.CurrencyPairID) AS t
    WHERE  (AmountReceivable > 0)
GO
/****** Object:  View [dbo].[SenderView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[DfrView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CostRate]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[CostRateView]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ReportCommission2]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[ReportCommission2]
AS
WITH t(TxnID, ReferenceNo, TradeDate, ClientTradingProfileID, ClientTradingProfileName, ClientCurrencyNameIn, ClientAmountIn, ClientCurrencyNameOut, ClientAmountOut, IntroducerID, IntroducerCommissionRate) AS (SELECT t.id, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       t.ReferenceNo, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       t.TradeDate, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       t.ClientTradingProfileID,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        t.ClientTradingProfileName,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        t.ClientCurrencyNameIn,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        t.ClientAmountIn,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        t.ClientCurrencyNameOut,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        t.ClientAmountOut,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        m.IntroducerID,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        m.IntroducerCommissionRate
                                                                                                                                                                                                                                                                                                                                                                                                                                                     FROM      dbo.TxnView AS
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        t INNER JOIN
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       dbo.ClientTradingProfileIntroducerMap
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        AS m ON 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       t.ClientTradingProfileID
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        = m.ClientTradingProfileID
                                                                                                                                                                                                                                                                                                                                                                                                                                                     WHERE   (m.IntroducerCommissionTypeID
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        = 2))
    SELECT t_1.TxnID, t_1.ReferenceNo, t_1.TradeDate, t_1.ClientTradingProfileID, t_1.ClientTradingProfileName, t_1.ClientCurrencyNameIn, t_1.ClientAmountIn, t_1.ClientCurrencyNameOut, t_1.ClientAmountOut, t_1.IntroducerID, 
                      t_1.IntroducerCommissionRate, ISNULL(t_1.IntroducerCommissionRate, 0) / 100 * r.ClientPayoutUSD AS IntroducerCommissionUSD
    FROM     t AS t_1 LEFT OUTER JOIN
                      dbo.ReportTxnOriginal AS r ON t_1.TxnID = r.TxnID
GO
/****** Object:  View [dbo].[ReportCommission1]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[ReportCommission1]
AS
WITH t(TxnID, ReferenceNo, TradeDate, ClientTradingProfileID, ClientTradingProfileName, ClientCurrencyNameIn, ClientAmountIn, ClientCurrencyNameOut, ClientAmountOut, IntroducerID, IntroducerCommissionRate) AS (SELECT t.id, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       t.ReferenceNo, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                       t.TradeDate, 
                                                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                     WHERE   (m.IntroducerCommissionTypeID
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        = 1))
    SELECT t_1.TxnID, t_1.ReferenceNo, t_1.TradeDate, t_1.ClientTradingProfileID, t_1.ClientTradingProfileName, t_1.ClientCurrencyNameIn, t_1.ClientAmountIn, t_1.ClientCurrencyNameOut, t_1.ClientAmountOut, t_1.IntroducerID, 
                      t_1.IntroducerCommissionRate, ISNULL(t_1.IntroducerCommissionRate, 0) / 100 * r.GrossProfitUSD AS IntroducerCommissionUSD
    FROM     t AS t_1 LEFT OUTER JOIN
                      dbo.ReportTxnOriginal AS r ON t_1.TxnID = r.TxnID
GO
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_InitCostRate]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE   PROCEDURE [dbo].[sp_InitCostRate]
	@TradeDate datetime
AS
BEGIN 
	SET NOCOUNT ON;
...
END
GO
/****** Object:  StoredProcedure [dbo].[sp_ReportAccountPayable]    Script Date: 11/27/2020 8:17:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE   PROCEDURE [dbo].[sp_ReportAccountPayable]
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportAccountReceivable'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportCommission1'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportCommission1'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportCommission2'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportCommission2'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportTxnModified'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportTxnModified'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportTxnOriginal'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportTxnOriginal'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane1', @value=N'[0E232FF0-B466-11cf-A24F-00AA00A3EFFF, 1.00]
Begin DesignProperties = 
   Begin PaneConfigurations = 
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 9
         ...
         Width = 1200
         Width = 1200
         Width = ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'SlipView'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'1200
         Width = 1200
         Width = 1200
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'TxnCompleteView'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'TxnView'
GO
USE [master]
GO
ALTER DATABASE [DB_A6159D_tradingPRD] SET  READ_WRITE 
GO
